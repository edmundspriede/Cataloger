<?php
		...
		$this->smarty->assign('attrlist',$params['attrlist']);
		$this->smarty->assign('image_url_array',$imageArray);
		$this->smarty->assign('file_url_array',$fileUrlArray);
		$this->smarty->assign('file_name_array',$fileArray);
		$this->smarty->assign('file_ext_array',$fileTypeArray);
		$this->smarty->assign('file_count',$actualfilecount);
        $this->smarty->assign('image_thumb_url_array',$thumbArray);
        $this->smarty->assign('src_image_url_array',$srcImgArray);
		$this->smartyBasics();
		
    echo $this->ProcessTemplateFromDatabase('catalog_' . $params['sub_template']);
    ## the next lines were a mistake... to be removed
